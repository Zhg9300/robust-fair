...
from ByrdLab.aggregation import (qFedAvg, mean,
                                 Krum, trimmed_mean, geometric_median, median, faba, centered_clipping)
from ByrdLab.attack import (gaussian, sign_flipping, disguise)
from ByrdLab.decentralizedAlgorithm import DSGD, CSGD, AFL, qFFL, Hnobs
...
parser.add_argument('--aggregation', type=str,
                    default='NBS')  # NBS, mean, trimmed-mean, median, geometric-median, mKrum, Krum, bulyan, cc, scc
parser.add_argument('--attack', type=str,
                    default='sign_flipping')  # disguise, none, sign_flipping, gaussian, sample_duplicate, zero_sum, zero_value, alie
...
if args.aggregation == 'mean':
    ...
    aggregation = faba
elif args.aggregation == 'DROmean':
    aggregation = DRO_meanW(graph)
...
elif args.attack == 'disguise' or 'sign_flipping' or 'gaussian':
    attack_name = attack
else:
...
# initilize optimizer
env = Hnobs(aggregation=aggregation, graph=graph, attack=attack,
