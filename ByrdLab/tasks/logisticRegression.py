...
num_classes = 10 # default 2

class LogisticRegressionTask(Task):
    def __init__(self, data_package: DataPackage, batch_size=64): #batch size: 32  # default 64
        ...
        super_params = {
            'rounds': 10,  # default 10
            'display_interval': 4000,  # default 4000
            'batch_size': batch_size,
            'test_batch_size': 900,  # default 900
