...
class softmaxRegressionTask(Task):
    def __init__(self, data_package: DataPackage, batch_size=64):# default 32
        weight_decay = 0.01# 偏大好 0.06 默认0.01
        ...
        super_params = {
            'rounds': 100,  # default 100
            'display_interval': 100,  # default 500
