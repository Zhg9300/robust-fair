...
from ByrdLab.aggregation import (Krum, mKrum, trimmed_mean, geometric_median, median, faba, brute, bulyan,mean)
from ByrdLab.attack import (gaussian, sign_flipping,disguise)
from ByrdLab.decentralizedAlgorithm import AFL, qFFL, DRFL, vanillaCSGD
...
from ByrdLab.library.partition import (LabelSeperation, TrivalPartition,
                                       iidPartition)
from ByrdLab.library.tool import log, NBS_AFL, NBS
from ByrdLab.tasks.leastSquare import LeastSquareToyTask, LeastSquareToySet
import torch
...
parser.add_argument('--aggregation', type=str,
                    default='trimmed-mean')  # NBS_AFL, mean, trimmed-mean, median, geometric-median, mKrum, Krum, bulyan, cc, scc
parser.add_argument('--attack', type=str,
                    default='gaussian')  # none, sign_flipping, gaussian, disguise, sample_duplicate, zero_sum, zero_value, alie
parser.add_argument('--data-partition', type=str, default='trival')  # default iid
...
data_package = LeastSquareToySet
task = LeastSquareToyTask()
...
# initilize optimizer
env = DRFL(aggregation=aggregation, graph=graph, attack=attack,
