...
from ByrdLab.aggregation import (mean, weight_mean, qFedAvg,
                                 Krum, trimmed_mean, geometric_median, median, faba, bulyan,brute)
...
parser.add_argument('--aggregation', type=str,
                    default='mean')  #  mean, brute, trimmed-mean, median, geometric-median, mKrum, Krum, bulyan
...
# initilize optimizer
env = AFL(aggregation=aggregation, graph=graph, attack=attack,
...
# print('acc_path:{} worst_path:{} var_path:{} '.format(acc_path, worst_acc_path, var_path))
