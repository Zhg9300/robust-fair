...
from ByrdLab.aggregation import (centered_clipping,
                                 Krum, mKrum, trimmed_mean, geometric_median, median, faba, brute, bulyan,mean)
from ByrdLab.attack import (gaussian, sign_flipping,disguise)
from ByrdLab.decentralizedAlgorithm import DRFL
...
from ByrdLab.library.partition import (LabelSeperation, TrivalPartition,
                                       iidPartition)
from ByrdLab.library.tool import log, NBS_AFL
...
parser.add_argument('--aggregation', type=str,
                    default='mean')  # NBS_AFL, mean, ios, trimmed-mean, median, geometric-median, mKrum, Krum, bulyan, cc, scc
parser.add_argument('--attack', type=str,
                    default='disguise')  # none, sign_flipping, gaussian, disguise
