...
from ByrdLab.aggregation import (Krum, mKrum, trimmed_mean, geometric_median, median, faba, bulyan, brute,
                                 qFedAvg, mean)
from ByrdLab.attack import (gaussian, sign_flipping,disguise)
from ByrdLab.decentralizedAlgorithm import CSGD, AFL, qFFL, fairFL, vanillaCSGD
...
parser.add_argument('--aggregation', type=str,
                    default='mean')  # qFedAvg, brute, mean, ios, trimmed-mean, median, geometric-median, mKrum, Krum, bulyan
parser.add_argument('--attack', type=str,
                    default='sign_flipping')  # none, sign_flipping, gaussian, disguise
...
# initilize optimizer
env = vanillaCSGD(aggregation=aggregation, graph=graph, attack=attack,
